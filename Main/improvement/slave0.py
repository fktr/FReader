...
BaseManager.register('get_task_queue_0')
BaseManager.register('get_result_queue_0')
...
class Slave:
    ...
    def __init__(self,t_num,p_num):
        self.taskq=manager.get_task_queue_0()
        self.resultq=manager.get_result_queue_0()
    ...
    def crawl_page(self,channel):
        ...
        print('@Host0 Put task %s into buffer queue...'%channel)
    ...
    def multi_threaded_crawling(self):
        ...
        while True:
            try:
                ...
                print('@Host0 Get task %s from task queue...' % channel)
    ...
    def multi_process_parsing(self):
        ...
        while True:
            try:
                ...
                print('@Host0 Get task %s from buffer queue...'%channel)
                #print(page_cont[:100])
    ...
    def wait_for_end(self):
        ...
        print("@Host0 Crawling end...")
        self.process_pool.close()
        self.process_pool.join()
        print("@Host0 Parsing end...")
    ...
    def async_wait_for_end(self):
        ...
        print('@Host0 Async Crawling end...')
        self.process_pool.close()
        self.process_pool.join()
        print("@Host0 Parsing end...")
...
def parse_page(channel, page_cont):
    ...
    resultq=manager.get_result_queue_0()
    resultq.put(result)
    print('@Host0 Put result %s into result queue...'%result[0])
